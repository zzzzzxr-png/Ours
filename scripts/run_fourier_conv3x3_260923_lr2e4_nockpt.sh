...
root=experiments/260923_fourier_conv3x3_41ch_convadd_interleaved_width48_64_96_128_batch1_lr2e-4_nockpt
...
run_one() {
    ...
    CUDA_VISIBLE_DEVICES="$gpu" PYTHONUNBUFFERED=1 "$python" -u \
        ...
        --n_epochs 100 --lr 2e-4 --b1 0.9 --b2 0.999 \
        --batch-size 1 \
        ...
        --skip-fusion conv_add --interleaved-transformer \
        --seed 1024 \
